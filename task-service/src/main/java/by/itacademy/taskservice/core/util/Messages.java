...
public class Messages {
    ...
    public static final String INCORRECT_DATA = "The request contains incorrect data. " +
            "Change request and try again or contact support!";
    ...
    public static final String REQUEST_ERROR = "Wrong dates. Problem in Project or(and) implementer. " +
